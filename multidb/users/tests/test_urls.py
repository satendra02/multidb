...
class TestUserURLs(TestCase):
    ...
    def test_list_reverse(self):
        """users:list.html should reverse to /users/."""
        self.assertEqual(reverse("users:list.html"), "/users/")

    def test_list_resolve(self):
        """/users/ should resolve to users:list.html."""
        self.assertEqual(resolve("/users/").view_name, "users:list.html")
